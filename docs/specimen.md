...
rST suggests the following “types”: _attention_, _caution_, _danger_, _error_, _hint_, _important_, _note_, _tip_, and _warning_; however, you’re free to use whatever you want.